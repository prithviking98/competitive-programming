 ...
 *                                 formatted;
 *                                 'diag' is 'diagnostic' - filenames are not
 *                                 formatted;
...
int main(int argc, char *argv[])
{
    ...
    //TODO: think about how to capture all-zero packets in 'check' mode
 ...
 *
 * Catches SIGTERM andCTRL+C and cleans up before exiting
 */
void MBR_HandleStopSignals(int iSigNo)
{
    int iRet = MBR_RET_SUCCESS;
...
void MBR_PrintUsage(const char *pcProgName)
{
    ...
    printf("                                'diag' is 'diagnostic' - filenames ");
    printf("are not formatted;\n");
