...
dir_fwrite_commands = "~/src/acquire/oldstuff_other/"
...
(status, output) = commands.getstatusoutput("mkdir write")
(status, output) = commands.getstatusoutput("mkdir fwrite")
...
# test case 1:
# no affinity
print "Running test case 1 (write)..."
...
(status, output) = commands.getstatusoutput("mv packet* write")

print "Test case 1 completed."

# test case 2:
# with affinity
print "Running test case 2 (fwrite)..."
...
# move the data files to the proper directory
(status, output) = commands.getstatusoutput("mv packet* fwrite")
