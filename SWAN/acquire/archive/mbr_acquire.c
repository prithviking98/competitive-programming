 ...
 *
 * Created by Peeyush Prasad on 10 April 2008
...
int main(int argc, char *argv[])
{
    ...
    bpf_u_int32 iNet = 0;
    bpf_u_int32 iMask = 0;
    int iFlagFiles = MBR_FALSE;
    int iFlagTime = MBR_FALSE;
    ...
    int i = 0;
    /* valid short options */
    const char* const sShortOpts = "hd:f:t:m:s:o:k";
    /* valid long options */
        ...
        switch (iNextOpt)
        {
            ...
            case 't':   /* -t or --time */
                ...
                if (!(iFlagFiles))
                {
                    ...
                    /* now convert the time to number of 2GB files */
                    g_iNumFiles = (g_iTime * 60) / MBR_TIMEPERFILE;
