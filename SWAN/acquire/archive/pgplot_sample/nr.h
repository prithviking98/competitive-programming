...
float erfcc(float x);
/* float erff(float x); comment out to aviod conflict with math.h */
float erffc(float x);
...
/* float select(unsigned long k, unsigned long n, float arr[]); comment to
   avoid conflict with math.h */
