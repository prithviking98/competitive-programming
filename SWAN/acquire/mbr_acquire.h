...
#define MBR_FILENPREFIX_SNIFFACQ    "raw"
#define MBR_PREFIX_CH               "ch"
#define MBR_NAME_PSR                "nopulsar"
#define MBR_LEN_PREFIX_CH           (strlen(MBR_PREFIX_CH))
#define MBR_DATAFILE_EXT            "mbr"
#define MBR_LEN_NAME_PSR            (strlen(MBR_NAME_PSR))
#define MBR_LEN_COUNT               3
#define MBR_LEN_CH                  2   /* the largest band number is '10' */
...
#define MBR_LEN_FILENAME            (MBR_LEN_PREFIX_CH + MBR_LEN_CH + 1 \
                                     + MBR_LEN_NAME_PSR + 1 \
                                     + MBR_LEN_TS + 1 \
                                     + MBR_LEN_COUNT + 1 \
...
/* acquisition modes */
#define MBR_MODE_OBS                0x03    /* DW, FF */
#define MBR_MODE_DIAG               0x01    /* DW */
#define MBR_MODE_SNIFFACQ           0x0F    /* DW, FF, SHM, PU */
#define MBR_MODE_SNIFF              0x0C    /* SHM, PU */
#define MBR_MODE_CHECK              0x10    /* SC */
...
/* the fastest data rate, to calculate the number of files to create on the
   M&C machine, in sniff mode */
#define MBR_FASTEST_DATARATE        66.0    /* MB/s */
